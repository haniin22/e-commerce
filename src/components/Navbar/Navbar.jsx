...
export default function Navbar() {
  ...
  return (
    <nav className="border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex mx-auto p-4 justify-between items-center">
        ...
        {/* Navbar links */}
        <div className="hidden w-full md:block md:w-auto mx-32 my-3" id="navbar-default">
        ...
        <div className="flex space-x-6 ml-4 items-center">
          <NavLink to="Cart">
            <i
              className="fa-solid fa-cart-shopping text-3xl"
              style={{ color: '#1bb154' }}
            />
          </NavLink>
